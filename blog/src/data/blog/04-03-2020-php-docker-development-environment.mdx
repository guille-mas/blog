...
Docker has a vibrant ecosystem of images you can use. One of the most popular repositories places to look for it's [DockerHub](https://hub.docker.com/ "DockerHub website"), with thousands of publicly available repositories, built by DevOps practitioners around the world.  
...
In this article, you learned how to pack and share an application with its development run-time environment. 
