...
The code samples are based on a containerized development environment for PHP 7.4 projects I'm maintaining at its [Github repository](https://github.com/guille-mas/awesome-php74-env "Demo project code").  
...
### Deep dive into a few critical files
