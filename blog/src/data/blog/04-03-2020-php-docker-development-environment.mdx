...
#### An introduction into DevOps processes
...
The code samples are based on a containerized development environment for PHP 7.4 projects I'm maintaining at its [Github repository](https://github.com/guille-mas/awesome-php74-env).  
A pre built docker image it's available at its [Dockerhub repo](https://hub.docker.com/r/guillermomaschwitz/awesome-php)  
...
I won't cover its content, but you can read an example at its [Github repository](https://github.com/guille-mas/awesome-php74-env).  
...
snippet={`docker build 
    -f ./Dockerfile 
    -t guillermomaschwitz/blog:2.0-production 
...
snippet={`docker build 
    -f ./Dockerfile 
    -t guillermomaschwitz/blog:2.0-development 
...
Later, I plan to show you how to automate the creation of a production-ready, auto-scalable [AWS ECS](https://aws.amazon.com/ecs/) infrastructure to run your containers. 
And how to automate and document your infrastructure-as-code with GNUMake and [Terraform](https://www.terraform.io/), 
