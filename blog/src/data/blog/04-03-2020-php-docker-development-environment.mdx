...
Every code sample its based on a containerized development environment for PHP 7.4 projects I'm maintaining at its [Github repository](https://github.com/guille-mas/awesome-php74-env).  
...
At Imaginary startup, a group of engineers work together on a tight loop, deploying several daily changes to their product.
...
Next to the old API, two new clusters are deployed.
