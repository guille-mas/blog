...
It's usual to see small startups, performing manual setup of development environments. The results are often a fragile mix of operating systems, libraries, and PHP versions. 
Other times, development environments are maintained by experienced IT teams; 
Who fiercely protect their infrastructure. Affecting the hability of development teams, to understand the underlying infrastructure, or try new ideas.  
...
Where developers can experiment agressively, in a consistent and sandboxed environment, that run fast and locally.

<br/>

Long gone are the days, where containers where a privileged practice of a few tech giants; An edgy technology promoted by crazy early adopters.  
With modern containerization tools like Docker, and orchestration tools like docker-compose, Swarms, or Kubernetes. 
It is a no brainer for small startups, to adopt some of these technologies. In order to provider better experiences for their customers, and more effective processes for their teams.
...
But it's the corner stone to modernize processes and stimulate more enjoyable, collaborative ways, of building software together.
