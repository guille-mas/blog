...
You can stop the container by passing its name or it's container ID when using docker's command stop
...
If you are curious, you can read the [Dockerfile code for this website at](https://github.com/guille-mas/blog/blob/master/Dockerfile)

### Configure Docker to work with your project
...
In the next post, I plan to show you how to use **docker-compose** to effectively documment in code our development environment.
