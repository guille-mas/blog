...
Or maybe because I try to learn a little bit of the business and organizational side on every project I work. 
Is that I've come to the conclusion, that human factors outweigh technical ones, in the fate of most business ideas. 
Simply because humans time is way more expensive than computers time, and human tasks take much longer as well.
So whenever I am working on internal tools, I try to think on the users like I do with customers; 
Empathy in my opinion, it's key to increase the business outcomes produced with them.  

<br />

In this post you will use Docker to wrap a PHP project into a full fledged, portable, development environment. With several tools to debug and understand your application.
Hopefully, the features contained on this development environment, will help you and your team, become more effective on your day to day duties.
