...
So, being empathetic while designing software; Being customer facing or an internal tool. Can have, in different ways, a significant impact on business outcomes.

### Goals of this post

In this post I show you how to use Docker to make a great PHP development environment. 
How to design it, write it, and wrap it, with concise docummentation, so your team can be more effective.
...
Using a PHP debugger will certainly make a huge difference in your productivity as a PHP developer.  
If you are debugging issues with var_dump() or print_r() you should really ( **reeeally** ) try this approach instead.
...
#### Write a Makefile, to wrap every workflow in a simple cli interface
...
In the next post I show you how to build a production version of this image with docker multi-stage builds. 
