...
I will try to be as gente as possible on this journey. 
But I will assume you grasp the basics about writing web applications in PHP, and basic Linux command line usage.
...
Before creating our first container, we will need a **Docker engine** version equal or greater than version 19.03, and **GNU Make**.
