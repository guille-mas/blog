...
Maybe because I studied psychology for a few years, before getting back into software development. 
Because I try to learn a little bit of the business and organizational side of the projects I get involved. 
Or simply because human time is more expensive, and take much longer, than computing time. 
It's my opinion that human factors outweigh technical ones, in the fate of most business ideas. 
So whenever I build internal tools, I try to think on the users of those tools like I do with customers. 
Empathy in my opinion, it's key to increase the business outcomes produced with them.
...
This website's is built inside a nodejs docker image whose [source code](https://github.com/guille-mas/blog/blob/master/Dockerfile) you could read if you want.  
...
4. Bind port 8080 on your host with 8000 on the container **-p 8080:8000**. 
5. Stream logs to STDOUT

The **--rm** flag tells docker to destroy the container once stopped.

<br/>

Check if your container is running with **docker container ls**.
...
## Create the development environment for a PHP project
