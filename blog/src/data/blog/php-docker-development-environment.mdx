...
Welcome to my first post on my first blog ( yikes! cold sweat! )  
...
If you follow through this tutorial, you will end up with a working, Linux based, PHP 7.4, portable development environment, with a working XDebug PHP debugger, that can be deployed with a single command, on virtually any computer that fulfills the needed requirements.  
