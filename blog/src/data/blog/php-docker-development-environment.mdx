...
intro: "Learn to build a containerized development environment with Docker, PHP 7 and XDebug"
...
Maybe because I studied psychology, before getting back into software development. 
...
In my opinion, being empathetic while designing software; Whether customer facing or an internal tool. Can have, in different ways, a significant impact on business outcomes.

### Goals of this post

In this post I show you how to use Docker to make a great PHP development environment. 
How to design it, write it, and wrap it, with powerful tools and concise docummentation, so your team can be more effective.
...
With docker you can pack applications with their own environment, build it once, and deploy it into any machine running a docker engine.  
...
I hope this first tutorial has been useful to you! Hopefully, you learned what's Docker, and how can it help you and your team.  
There is still a lot to learn though. This is a single container environment and it's not suitable for production. 
But it's the corner stone, to modernize processes and stimulate more enjoyable, collaboratively ways of building software together.

<br/>

I did my best to guide you through this introductory exploration of Docker concepts, and a few use cases.
Above all, I tried to share a few technical tricks to improve collaboration and communication between devs in a team, and between devs and ops teams.
